...
export const SubAgentCardItem = ({...props}) => {
    ...
    return (
      ...
      <TouchableOpacity
        onPress={() =>{
          ...
          props.navigate(props.item.agent_id,props.item.agent_image,props.lang==1?item.agent_name:item.agent_name_ar,props.item.total)
          }}
      >
      ...
      <Image source={{uri:BaseURL + item.agent_image}} style={{height: '30%', width: '45%', resizeMode:'contain'}}/>
      <View  style={{justifyContent:'center',alignItems:'center',}} >
      <Text   numberOfLines={2}
 style={[styles.itemText,{marginTop:7,marginBottom:0,color:'#707070'}]}>{props.lang==1?item.agent_name:item.agent_name_ar}</Text>
 </View>
